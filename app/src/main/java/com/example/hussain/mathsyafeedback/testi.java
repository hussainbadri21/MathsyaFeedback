...
public class testi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx=(TextView)findViewById(R.id.editText9) ;
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!check) {
                    ...
                    new AddNewPrediction().execute(sat, value, help, selection, quality, name, address, tel, mob, email, bday, anniversary, "null", suggestion);
                    Intent i = new Intent(testi.this, done.class);
                    startActivity(i);
                    finish();
                }
            }
        ...
        {
            if(ed1.length()==0  || ed4.length()==0  || ed5.length()==0  || ed6.length()==0  || ed8.length()==0  || rg1.getCheckedRadioButtonId()==-1  )
